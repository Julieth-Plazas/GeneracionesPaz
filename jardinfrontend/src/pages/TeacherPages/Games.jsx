  ...
  return (
    <div className="bg-base-100 shadow-inner border-t">
      <div className="collapse collapse-plus w-15 collapse-arrow bg-white">
        ...
        <div className="collapse-title text-xl font-medium">Juego 1</div>
      ...
      <div className="collapse collapse-arrow bg-white">
        ...
        <div className="collapse-title text-xl font-medium">Juego 2</div>
        <div className="collapse-content">
          <Game2></Game2>
        </div>
      </div>
      <div className="collapse collapse-arrow bg-white">
        <input type="radio" name="my-accordion-2" />
        <div className="collapse-title text-xl font-medium">Juego 3</div>
        <div className="collapse-content">
          <Game3></Game3>
        </div>
      </div>
      <div className="collapse collapse-arrow bg-white">
        <input type="radio" name="my-accordion-2" />
        <div className="collapse-title text-xl font-medium">Juego 4</div>
        <div className="collapse-content">
          <Game4></Game4>
        </div>
      </div>
      <div className="collapse collapse-arrow bg-white">
        <input type="radio" name="my-accordion-2" />
        <div className="collapse-title text-xl font-medium">Juego 5</div>
        <div className="collapse-content">
          <iframe
